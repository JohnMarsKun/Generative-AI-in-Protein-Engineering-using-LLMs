...
def plot_amp_histogram(file_path, model_name: str = ''):
    ...
    plt.tight_layout()
    #plt.savefig("/home/johnny/Downloads/EvoDiff-AMPs/RankingHist-CAMP-D3PM-ANN.pdf")
    plt.show()

# CAMP-rank-D3PM-RF.txt
file_path = '/home/johnny/Downloads/EvoDiff-AMPs/CAMP-rank-D3PM-ANN.txt'
plot_amp_histogram(file_path, '(ANN) - D3PM640M')
